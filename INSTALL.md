...
==================
These are instructions for building dfc-core from source.
...
#### Ubuntu 14.04
You will have to install the [test toolchain](#adding-the-test-toolchain) in order to both build and run dfc-core.

#### Ubuntu 16.04
Just like 14.04, you can install the test toolchain to build and run dfc-core.
