...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "DfcBlockChain Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.dfc.org/papers/dfc-consensus-protocol.pdf).
...
- Set of core validator nodes. Running dfc-core only. Tasked with:
...
- Set of public HTTP nodes. Not running dfc-core. Running
...
- (optional): Set of public validator nodes. Running dfc-core only. Tasked
with:
  ...
  - Basically just a dfc-network load balancer / firewall for public access,
