...
- **Ledger**: A ledger is the state of the distributed DfcBlockChain database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/DfcBlockChain-ledger.x`](/src/xdr/DfcBlockChain-ledger.x))


`DfcBlockChain-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `dfc-core` can be configured to upload detailed historical
