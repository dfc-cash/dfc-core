...
Note that you can (and should) install the Windows version of postgres even when running dfc-core from within WSL.


# Basic Installation

- `git clone PATH_TO_DFCBlockChain_CORE`
- `git submodule init`
- `git submodule update`
- Open the solution `Builds\VisualStudio\dfc-core.sln`
