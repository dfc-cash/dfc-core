...
class HerderSCPDriver : public SCPDriver
{
  public:
    struct ConsensusData
    {
        ...
        DfcBlockChainValue mConsensusValue;
        ConsensusData(uint64_t index, DfcBlockChainValue const& b)
    ...
    void restoreSCPState(uint64_t index, DfcBlockChainValue const& value);
    ...
    void nominate(uint64_t slotIndex, DfcBlockChainValue const& value,
                  TxSetFramePtr proposedSet, DfcBlockChainValue const& previousValue);
  ...
  private:
    ...
    validateValueHelper(uint64_t slotIndex, DfcBlockChainValue const& sv) const;
