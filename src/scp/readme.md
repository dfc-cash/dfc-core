# SCP (DfcBlockChain Consensus Protocol)
...
in the file [DfcBlockChain-SCP.x](../xdr/DfcBlockChain-SCP.x)

The `dfc-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.dfc.org/papers/dfc-consensus-protocol.pdf).
