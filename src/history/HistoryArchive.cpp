...
{
    return std::string("dfc-history.json");
}
...
HistoryArchiveState::HistoryArchiveState() : server(DFCBlockChain_CORE_VERSION)
{
    uint256 u;
...
HistoryArchiveState::HistoryArchiveState(uint32_t ledgerSeq,
    ...
    : server(DFCBlockChain_CORE_VERSION), currentLedger(ledgerSeq)
{
