          ...
          "[db][dbconnectionstring]")
{
    ...
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://password=abc dbname=dfc)") ==
                R"(postgresql://password=******** dbname=dfc)");
    }

    SECTION("password is removed if second")
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://dbname=dfc password=dbname)") ==
                R"(postgresql://dbname=dfc password=********)");
    }
    ...
    SECTION("quoted password is removed")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=dfc password='quoted password')") ==
            R"(postgresql://dbname=dfc password=********)");
    }
    ...
    SECTION("parameters after password remain unchanged")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=dfc password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname=dfc password=******** performance='as fast as possible')");
    }
    ...
    SECTION("dbname can be quored")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname='dfc with spaces' password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname='dfc with spaces' password=******** performance='as fast as possible')");
    }
