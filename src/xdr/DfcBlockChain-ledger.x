...
/* DfcBlockChainValue is the value used by SCP to reach consensus on a given ledger
*/
...
struct LedgerHeader
{
    ...
    DfcBlockChainValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from DfcBlockChainValue is normalized such that
