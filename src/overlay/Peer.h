             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvMessage(DfcBlockChainMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(DfcBlockChainMessage const& msg);
    void updatePeerRecordAfterEcho();
    void updatePeerRecordAfterAuthentication();
    void recvAuth(DfcBlockChainMessage const& msg);
    void recvDontHave(DfcBlockChainMessage const& msg);
    void recvGetPeers(DfcBlockChainMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(DfcBlockChainMessage const& msg);

    void recvGetTxSet(DfcBlockChainMessage const& msg);
    void recvTxSet(DfcBlockChainMessage const& msg);
    void recvTransaction(DfcBlockChainMessage const& msg);
    void recvGetSCPQuorumSet(DfcBlockChainMessage const& msg);
    void recvSCPQuorumSet(DfcBlockChainMessage const& msg);
    void recvSCPMessage(DfcBlockChainMessage const& msg);
    void recvGetSCPState(DfcBlockChainMessage const& msg);
  ...
  public:
    ...
    void sendMessage(DfcBlockChainMessage const& msg);
